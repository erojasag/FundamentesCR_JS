                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-second-primary">
                                    <h6 class="m-0 font-weight-bold text-white">Lista de DatosSocioEconomicos</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table table-bordered" id="tbdata" cellspacing="0" style={{ width: '100%' }}>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Tiger Nixon</td>
                                                        <td>
                                                            <a href="EditarDatosSE" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            <a href="EditarDatosSE" class="btn btn-danger btn-sm"
