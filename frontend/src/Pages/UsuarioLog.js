                                                    ...
                                                    <table class="table table-bordered" id="tbdata" cellspacing="0" style={{width:'100%'}}>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Edi@gmail.com</td>
                                                                <td>
                                                                    <a href="EditarUsuarioLog.html" class="btn btn-primary btn-sm">
                                                                        <i class="fas fa-pencil-alt"></i>
                                                                    </a>
                                                                    <a href="EditarUsuario.html" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
