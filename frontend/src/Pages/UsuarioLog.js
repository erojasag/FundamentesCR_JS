                                            ...
                                            <table class="table table-bordered" id="tbdata" cellspacing="0" style={{ width: '100%' }}>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Edi@gmail.com</td>
                                                        <td>
                                                            <a href="EditarUsuarioLogUsuarioLog" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            <a href="EditarUsuarioLogUsuario" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="email" class="form-control form-control-sm input-validar" id="Sexo" name="Sexo" />
                                                            </div>
                                                            <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="email" class="form-control form-control-sm input-validar" id="PoblacionPoblacion" name="Poblacion" />
                                                            </div>
                                                            <div class="form-group col-sm-6">
                                                                <label for="txtCorreo">Contraseña</label>
                                                                <input type="email" class="form-control form-control-sm input-validar" id="Nacionalidad" name="Nacionalidad" />
                                                            </div>
                                                            <div class="form-group col-sm-6">
