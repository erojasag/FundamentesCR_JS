        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-second-primary">
                    <h6 class="m-0 font-weight-bold text-white">Lista de Datos de Expedientes</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a class="btn btn-success" href="AgregarDatosExp.html"><i class="fas fa-user-plus"></i> Nuevo Expediente</a>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
                            ...
                            <table class="table table-bordered" id="tbdata" cellspacing="0" style={{width:'100%'}}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Activo</td>
                                        <td>
                                            <a href="EditarDatosExpediente" class="btn btn-primary btn-sm">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a href="EditarDatosExpediente" class="btn btn-danger btn-sm"
