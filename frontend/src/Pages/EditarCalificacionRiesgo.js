                            ...
                            <div class="container-fluid">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3 bg-second-primary">
                                        <h6 class="m-0 font-weight-bold text-white">Editar Calificación Riesgo</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="form-group col-sm-6">
                                                        <label for="txtCalificacion">Calificación del Riesgo</label>
                                                        <input type="number" class="form-control form-control-sm input-validar"
                                                            id="txtCalificacion" name="txtCalificacion" />
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                                        <label for="txtRiesgoPsicosocial">Riesgo Psicosocial</label>
                                                        <input type="number" class="form-control form-control-sm input-validar"
                                                            id="txtRiesgoPsicosocial" name="txtRiesgoPsicosocial" />
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                                        <label for="txtMotivo">Motivo de Consulta</label>
                                                        <input type="text" class="form-control form-control-sm input-validar"
                                                            id="txtMotivo" name="txtMotivo" />
                                                    </div>
                                                    <div class="form-group col-sm-6">
