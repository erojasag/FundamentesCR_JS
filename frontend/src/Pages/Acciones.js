      ...
      <div id="wrapper">
        ...
        >
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="usuarioLog.html">
                  Usuarios
                </a>
                <a class="collapse-item" href="EditarUsuarioLog.html">
                  Editar Usuario
                </a>
              </div>
            </div>
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="usuarios.html">
                  Paciente
                </a>
                <a class="collapse-item" href="EditarUsuario.html">
                  Editar Paciente
                </a>
              </div>
            </div>
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="DatosExpediente.html">
                  Datos de Expedientes
                </a>
                <a class="collapse-item" href="usuarios.html">
                  Datos de Pacientes
                </a>
                <a class="collapse-item" href="PersonaResponsable.html">
                  Persona Responsable
                </a>
                <a class="collapse-item" href="Convivencia.html">
                  Convivencia
                </a>
                <a class="collapse-item" href="DatosSocioEconomicos.html">
                  Datos SocioEconomicos
                </a>
                <a class="collapse-item" href="FactorPsicosocial.html">
                  Factor Psicosocial
                </a>
                <a class="collapse-item" href="CalificacionRiesgo.html">
                  Calificación Riesgo
                </a>
                <a class="collapse-item" href="EstadoExpediente.html">
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="PerfilEntrada.html">
                  Perfil de Entrada
                </a>
                <a class="collapse-item" href="EditarPerfilEntrada.html">
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="PerfilSalida.html">
                  Perfil de Salida
                </a>
                <a class="collapse-item" href="EditarPerfilSalida.html">
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="ListaEncuestas.html">
                  Encuesta de Satisfacción
                </a>
                <a class="collapse-item" href="Encuestas.html">
                  Agregar Encuesta
                </a>
              </div>
            </div>
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="reporteExpediente.html">
                  Datos Expedientes
                </a>
              </div>
            </div>
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="Acciones.html">
                  Reporte de Acciones
                </a>
              </div>
            </div>
