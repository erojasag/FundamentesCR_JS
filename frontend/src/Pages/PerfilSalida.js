            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-second-primary">
                        <h6 class="m-0 font-weight-bold text-white">Lista de Perfiles de Salida</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                                <button class="btn btn-success" data-toggle="modal" data-target="#modalData"><i
                                        class="fas fa-user-plus"></i> Nuevo Perfil de Salida</button>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
                                ...
                                <table class="table table-bordered" id="tbdata" cellspacing="0" style={{width:'100%'}}>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Sixaola</td>
                                            <td>
                                                <a href="EditarPerfilSalida.html" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a href="EditarPerfilSalida.html" class="btn btn-danger btn-sm" data-toggle="modal"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="date"
                                                        class="form-control form-control-sm input-validar"
                                                        id="txtFechaSalida" name="txtFechaSalida"/>
                                                </div>
                                                <div class="form-group col-sm-6">
