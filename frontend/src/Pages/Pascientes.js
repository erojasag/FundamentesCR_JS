...
export default function Pascientes() {
  return (
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a class="btn btn-success" href="AgregarPersonaResponsable"><i
                            ...
                            <table class="table table-bordered" id="tbdata" cellspacing="0" style={{width:'100%'}}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Si</td>
                                        <td>
                                            <a href="EditarUsuario.html" class="btn btn-primary btn-sm">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a href="EditarUsuario.html" class="btn btn-danger btn-sm"
                                                data-toggle="modal" data-target="#usuariosModal">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="usuariosModalLabel" data-dismiss="modal">Eliminar</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="close"  data-dismiss="modal" >Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
