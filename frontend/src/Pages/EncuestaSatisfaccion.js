...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-second-primary">
                            <h6 class="m-0 font-weight-bold text-white">Lista de Grados de Satisfacción</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3">
                                    <a class="btn btn-success" href="Encuestas"><i class="fas fa-user-plus"></i> Agregar Encuesta</a>
                                </div>
                            </div>
                            <hr/>
                            <div class="row">
                                        ...
                                        <table class="table table-bordered" id="tbdata" cellspacing="0" style={{width:'100%'}}>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>19</td>
                                                    <td>
                                                        <a href="EditarEncuesta.html" class="btn btn-primary btn-sm">
                                                            <i class="fas fa-pencil-alt"></i>
                                                       </a>
                                                       <a href="EditarEncuesta.html" class="btn btn-danger btn-sm" data-toggle="modal"
        ...
        <div class="modal fade" id="encuestaModal" tabindex="-1" aria-labelledby="encuestaModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="encuestaModalLabel" data-dismiss="modal">Eliminar</h5>
